...
The \textbf{projection} of $\vec{u}$ onto $\vec{v}$ is the \@{vector} paralell to $\vec{v}$ that's \@{magnitude} is component of $\vec{u}$ in the \@{direction} of $\vec{v}$.
...
\[ \proj_{\vec{v}} \vec{u} = \frac{\vec{u} \cdot \vec{v}}{\lVert \vec{v} \rVert^2} \vec{v} \]

\subsection{Component}

The \@{length} of the projection of $\vec{u}$ in the direction of $\vec{v}$ is called the \textbf{component} of $\vec{u}$ in the direction of $\vec{v}$ and is written as:

\[ \comp_v u =  \lVert \proj_{\vec{v}} \vec{u} \rVert = \frac{\vec{u} \cdot \vec{v}}{\lVert \vec{v} \rVert} \]
