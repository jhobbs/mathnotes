...
\begin{itemize}
\item each time we swap a row, multiply the determinant by -1
\end{itemize}

\begin{itemize}
\item each time we multiply a row by a \@{scalar}, multiply the determinant by that scalar
\end{itemize}

\begin{itemize}
\item adding a multiple of one row to another doesn't change the determinant.
\end{itemize}
