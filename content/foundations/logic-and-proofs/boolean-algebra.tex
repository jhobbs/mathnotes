...
\textbf{Modus Ponens:} $ P \rightarrow Q, P \vdash Q. $

\textbf{Modus Tollens:} $ P \rightarrow Q, \neg Q \vdash \neg P. $

\textbf{Or Introduction:} $ P \vdash (P \lor Q). $

\textbf{And Introduction:} $ P, Q \vdash (P \land Q). $

\textbf{And Elimination:} $ (P \land Q) \vdash P, Q. $

\textbf{Material Implication:} $(P \rightarrow Q) \vdash (\neg P \lor Q). $

\subsection{De Morgan's Laws}

\begin{theorem}\label{negation-of-disjunction-is-conjunction-of-negations}
...
\begin{theorem}\label{negation-of-conjunction-is-disjunction-of-negations}
