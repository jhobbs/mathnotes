...
The circle $\|z - z_0\| < $ in which the \@{Taylor-series} \@{converges} to the \@{function} is called the \textbf{circle of convergence} for the \@{Taylor-series}.
\end{definition}

\begin{definition}[Radius of Convergence]
The radius of the \@{circle-of-convergence} is called the \textbf{radius of convergence.}
\end{definition}
