...
\begin{intuition}
See \@{integral-of-one-over-z-around-unit-circle} and consider \@[path independence]{path-independent} and the principle of path deformation. Consider toy contours, particularly a collapsed keyhole contour around the singularity.
\end{intuition}
