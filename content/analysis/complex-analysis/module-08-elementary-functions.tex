...
$e^z$ is an \@[entire function]{entire-function}.
...
$\cos{z}$ and $\sin{z}$ are \@[entire functions]{entire-functions}. They have the same zeros as the real versions and the expected derivatives.
...
These are \@[entire functions]{entire-functions} with the expected derivatives.
...
This means there is some $k \in \integers$ for which the equation holds.
...
\subsection{General Powers of z}
