...
:::define "Zero"
A point $z_0$ is called a \textbf{zero} of an order $m$ of a \@{complex-function} $f$ if $f$ is \@[analytic]{analytic-at-a-point} at $z_0$ and
...
valid in some circle $\|z - z_0\| < R$, where $g(z)$ is \@[analytic]{analytic-at-a-point} at $z_0$ and $g(z_0) \neq 0$, then $f(z)$ has a zero of order $m$ at $z_0$.
\end{theorem}
