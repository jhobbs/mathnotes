...
\includegraphics[width=344px, height=336px]{https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/2D_polar.svg/1024px-2D_polar.svg.png}

\subsection{Converting Between Rectangular and Polar}
...
\subsection{Radial and Transverse Components of Motion}
...
\textbf{Radial}: The particle's motion in the direction away from the origin, that is, in the direction that purely increases the $r$ coordinate of the particle's position.

\textbf{Transverse}: The particle's motion in the direction tangential to its radius, that is, in the direction that purely increases the $\theta$ coordinate of the particle's position.
...
\includegraphics[alt={Radial and Transverse Components}, title={Radial and Transverse Components}]{radial-and-transverse-components.jpg}
