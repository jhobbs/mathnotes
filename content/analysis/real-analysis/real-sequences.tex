...
Example: The limit of the sequence $a_n = \frac{3n}{n+1}$ is $3$. \emph{Proof:} We need to show that given $\epsilon > 0$, there is some $N \in \naturals$ where if $n > N$, $\|\frac{3n}{n+1} - 3\| < \epsilon$. First, note that
...
The \textbf{Bolzano-Weirstrass Theorem} states that if a sequence of \@{real-numbers} is bounded, then it has a convergent subsequence.
