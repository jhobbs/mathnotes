...
\begin{proof}
Let $x \in \mathbb{R}$ and $\epsilon > 0.$ Pick $n \in \mathbb{N}$ such that $1/n < \epsilon.$ Now, because \@[the reals are Archimedean]{reals-are-archimedean}, for some $m \in \integers$ we have that $m = \lfloor nx \rfloor.$ Then,
...
\begin{proof}
Pick $n \in \mathbb{N}$ such that $n(y - a) > 1.$ Because because \@[the reals are Archimedean]{reals-are-archimedean}, there is some $k \in \integers$ such that $nx < k < ny$ and $x < n/k < y.$ Thus, $q = n/k \in \mathbb{Q}$ and $r \in (x, y).$
\end{proof}
