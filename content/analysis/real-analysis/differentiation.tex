...
For $f: (a,b) \to \reals, a,b \in \reals$, we say the \textbf{derivative} of $f$ at $x,$ denoted $f'(x)$ is given by
...
The real valued function on the real line $f$ is said to have a \textbf{local maximum} at $c \in \reals$ if there exists a $\delta > 0$ such that $f(x) \leq f(c)$ for all $x \in (c - \delta, c + \delta).$

The real valued function on the real line $f$ is said to have a \textbf{local minimum} at $c \in \reals$ if there exists a $\delta > 0$ such that $f(x) \geq f(c)$ for all $x \in (c - \delta, c + \delta).$
