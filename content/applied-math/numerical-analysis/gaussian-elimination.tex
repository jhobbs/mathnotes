...
\begin{itemize}
\item The leading coefficient (also called the pivot) of a nonzero row is always to the right of the leading coefficient of the row above it.
\end{itemize}

\begin{itemize}
\item The entries below each pivot are zero.
\end{itemize}
...
\begin{itemize}
\item Row $r_i$ can be replaced by $\lambda r_i,$ where $\lambda$ is any non-zero constant.
\end{itemize}

\begin{itemize}
\item Row $r_i$ can be replaced with $r_i + \lambda r_j,$ where $\lambda$ is any non-zero constant.
\end{itemize}

\begin{itemize}
\item Row $r_i$ and row $r_j$ can be swapped.
\end{itemize}
...
\begin{itemize}
\item Multiplier for row 2:  
\end{itemize}
     
\[ m_{21} = \frac{4}{2} = 2. \]

\begin{itemize}
\item Multiplier for row 3:
\end{itemize}
