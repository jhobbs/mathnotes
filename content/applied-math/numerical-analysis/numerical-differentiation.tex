...
This approach is called the \textbf{forward-difference formula} if $h > 0$ and the \textbf{backward-difference formula} if $h < 0.$ 
...
The \textbf{$(n+1)$-point formula} to approximate $f'(x_j)$ is
