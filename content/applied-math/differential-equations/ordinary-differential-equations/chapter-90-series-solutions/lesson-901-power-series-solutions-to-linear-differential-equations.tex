...
\title{Power Series Solutions to Linear Differential Equations}

\begin{document}

\section{Power Series Solutions to Linear Differential Equations}

It may be helpful to review \pagelink[shifting the summation index]{analysis/real-analysis/summation} before proceeding. 
...
\subsection{Existince of Analytic Solutions}
