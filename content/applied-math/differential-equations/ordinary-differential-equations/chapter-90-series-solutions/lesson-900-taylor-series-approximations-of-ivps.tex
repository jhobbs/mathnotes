...
\title{Taylor Polynomial Approximations of IVPs}

\begin{document}

\section{Taylor Polynomial Approximations of IVPs}
...
We know that y''= 3y' = x\textasciicircum{}2y for some interval around $x_0 = 0$ (why?), and can differentiate both sides to derive:
...
In general this process is very tedious and can be difficult to do by hand without making errors. I have written a \href{https://github.com/jhobbs/mathnotes/blob/main/scripts/taylor_series_approx.sage}{sage script that finds the Taylor polynomial approximation for IVPs}, which makes this process quick and accurate.
