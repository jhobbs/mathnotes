...
\title{Equations Permitting a Choice of Method}

\begin{document}

\section{Equations Permitting a Choice of Method}
...
\subsection{Solution by Substitution and Other Means}

There are plenty of first order differential equations that aren't solvable by any of the means discussed so far. It is possible in some cases to solve a differential equation by means of a \emph{shrewd substitution}, or by discovering an integrating factor, or by some other ingenious method. Beware though, that you can spend days trying these approaches and not find any solutions in terms of elementary functions, because most differential equations don't have such solutions.
...
\emph{jmh} the trick here was to multiply by a trig function that turned the first term (with $y'$) into the derivative of the second term, making a linear first order ode.
