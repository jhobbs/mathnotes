...
\title{Meaning of the Differential}
...
\section{Meaning of the Differential}

\subsection{Differential of a Function of One Independent Variable}

\emph{Note: Assume all functions in the lesson are \@{differentiable} on an \@{interval}.}
...
We call $dy$ the \textbf{differential} of $y$, i.e. it is the differential of the function defined by $y = f(x)$.
...
\emph{\textbf{Definition 6.13 The differential of y}}
Let $y=f(x)$ define y as a function of x on an \@{interval} $I$. The \textbf{differential of y}, writen as $dy$ (or $df$) is defined by

\[ (dy)(x,\Delta x) = f'(x)\Delta x \tag{6.14} \]

\subsection{Differential of a function of Two Independent Variables}

\emph{\textbf{Definition 6.4 Differential of z}}
Let $z = f(x,y)$ define $z$ as a function of $x$ and $y$. The \textbf{differential of z}, written as $dz$ or $df$, is defined by:

\[ (dz)(x,y,\Delta x,\Delta y) = \frac{\partial f(x,y)}{\partial x}\Delta x + \frac{\partial f(x,y)}{\partial y}\Delta y \tag{6.41} \]

\subsection{Differential Equations with Separable Variables}
...
Written in this form, either $x$ or $y$ may be considered as being the dependent variable. However, in both cases, $dy$ and $dx$ are \emph{differentials} and not incremements.
...
\emph{\textbf{Separable Variables}}

If it is possible to rewrite (6.6) or (6.61) in the form

\[ f(x)dx + g(y)dy = 0 \tag{6.62} \]

so that the coefficient of $dx$ is a function of $x$ alone and the coefficient of $dy$ is a function of $y$ alone, the variables are called \textbf{separable}. And after they have been put in the form (6.62), they are said to be \textbf{separated}. A 1-parameter family of solutions of (6.62) is then
