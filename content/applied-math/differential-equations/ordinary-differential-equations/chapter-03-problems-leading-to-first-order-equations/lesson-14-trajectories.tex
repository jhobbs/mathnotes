...
\includegraphics[alt={Isogonal Trajectories}]{/mathnotes/applied-math/differential-equations/ordinary-differential-equations/chapter-03-problems-leading-to-first-order-equations/isogonal-trajectories.jpg}
...
\emph{\textbf{Definition 14.12}} A curve which cuts every member of a given 1-parameter family of curves in the \emph{same angle} is called an \textbf{isogonal trajectory of the family}.
...
\textbf{Definition 14.2} A curve which cuts every member of a given 1-parameter family of curves in a $90^\circ$ angle is called an \textbf{orthogonal trajectory} of the family.
...
\subsubsection{Orthogonal Trajectories in Polar Coordinates}

\includegraphics[alt={Orthogonal Trajectories in Polar Coordinates}]{/mathnotes/applied-math/differential-equations/ordinary-differential-equations/chapter-03-problems-leading-to-first-order-equations/orthogonal-trajectories-in-polar-coordinates.jpg}
...
\begin{enumerate}
\item Calculate $r\frac{d\theta}{dr}$ of the given family.
\item Replace $r\frac{d\theta}{dr}$ by its negative reciprocal $- \frac{dr}{rd\theta}$
\item The family of solutions of this new resulting differential equation is orthogonal to the given family.
\end{enumerate}

\subsubsection{Some cool examples}

\href{https://www.desmos.com/calculator/9jcfrvjdr3}{Orthogonal Families of Hyperbolae}

\href{https://www.desmos.com/calculator/vmgdkbri74}{Apollonian Circles}

\href{https://www.desmos.com/calculator/qwtybju4hl}{The Cover of the Book}
