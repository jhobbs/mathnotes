...
\subsection{Problems Relating to the Tangent Lines to an Unknown Family of Curves}
...
\includegraphics[alt={Projection}]{/mathnotes/applied-math/differential-equations/ordinary-differential-equations/chapter-03-problems-leading-to-first-order-equations/projection.jpg}

\textbf{Tangent Line and Normal Line}
...
\includegraphics[alt={Normal and Tangent}]{/mathnotes/applied-math/differential-equations/ordinary-differential-equations/chapter-03-problems-leading-to-first-order-equations/normal-and-tangent.jpg}
