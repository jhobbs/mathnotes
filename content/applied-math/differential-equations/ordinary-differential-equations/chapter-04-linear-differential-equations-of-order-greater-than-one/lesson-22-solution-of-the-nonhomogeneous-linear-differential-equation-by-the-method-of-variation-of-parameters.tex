...
\title{Solution of the Nonhomogeneous Linear Differential Equation by the Method of Variation of Parameters}

\begin{document}

\section{Solution of the Nonhomogeneous Linear Differential Equation by the Method of Variation of Parameters}
...
\begin{enumerate}
\item The coefficients are constant
\item $Q(x)$ is a function which has a finite number of linearly independent derivatives
\end{enumerate}
