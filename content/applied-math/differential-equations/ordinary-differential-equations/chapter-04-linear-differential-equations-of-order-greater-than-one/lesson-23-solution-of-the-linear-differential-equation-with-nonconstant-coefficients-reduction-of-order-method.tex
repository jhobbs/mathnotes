...
\title{Solution of the Linear Differential Equation with Nonconstant Coefficients. Reduction of Order Method.}

\begin{document}

\section{Solution of the Linear Differential Equation with Nonconstant Coefficients. Reduction of Order Method.}
...
\subsection{Reduction of Order Method}
...
There is a method, called the \textbf{reduction of order} method, to obtain a second independent solution of $(23.14)$ as well as a particular solution of the related nonhomogenous equation:
...
(\emph{jmh} why do we/why can we make this assumption? the book does not explain).
