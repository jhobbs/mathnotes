...
\title{Introductory PDE Stuff}
\description{First round of notes from my second course on PDEs}

\begin{document}

\begin{definition}[System of Differential Equations]
A \textbf{system of differential equations} is a collection of one or more equations relating the derivatives of one or more functions. It is required that all the functions in the system depend on the same set of variables.
\end{definition}
...
\subsection{Basic Transport Equation}
...
\subsection{Transport with Decay}
...
\subsection{Non-Uniform Transport}
