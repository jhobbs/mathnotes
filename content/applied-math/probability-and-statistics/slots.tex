...
\subsection{No Two Reels Match on Any Spin}
...
\subsubsection{Two Reels Match on a Single Spin}
...
\begin{itemize}
\item reel one matches reel two
\item reel one matches reel three
\item reel two matches reel three
\end{itemize}
...
\includegraphics[alt={At least two matches with n labels on three reels}]{at_least_two_matches_with_n_labels.png}

\subsubsection{No Two Reels Match Across Multiple Spins}
...
\includegraphics[alt={No matches across 20 spins}]{no_matches_across_20_spins.png}
...
\subsection{All Three Reels Match on At Least One Spin}
...
\includegraphics[alt={At least one case of three matches}]{at_least_one_case_of_three_matches.png}
