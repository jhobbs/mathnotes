...
\begin{theorem}[Confidence Interval for a Mean, Known Variance]\label{ci-mean-known-variance}
...
\begin{theorem}[Sample Size for Estimating a Mean]\label{sample-size-mean}
...
\begin{theorem}[Confidence Interval for a Mean, Unknown Variance]\label{ci-mean-unknown-variance}
If $\bar{x}$ is the mean of a random sample of size $n$ from a population with an unknown \@{variance}, and the \@{standard-deviation} of the sample is $s$, a $100(1-\alpha)\%$ \@{confidence-interval} for $\mu$ is given by
...
\begin{theorem}[Large-Sample Confidence Interval for a Proportion]\label{ci-proportion}
...
\begin{theorem}[Sample Size for Estimating a Proportion]\label{sample-size-proportion}
...
\begin{theorem}[Conservative Sample Size for Estimating a Proportion]\label{sample-size-proportion-conservative}
