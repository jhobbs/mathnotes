...
A \@{random-variable} is called a \textbf{discrete random variable} if its set of possible outcomes is \@{countable}.
\end{definition}

\begin{definition}[Continuous Random Variable]
A \@{random-variable} is called a \textbf{continuous random variable} if it takes values on a continuous scale.
\end{definition}
