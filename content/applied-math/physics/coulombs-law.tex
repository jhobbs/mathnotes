...
where $\hat{r}$ is a \@{unit-vector} that points along the radial axis extending through the two particles and $k$ is the electrostatic constant $\frac{1}{4 \pi \epsilon_0}$, where $\epsilon_0$ is the \textbf{permittivitiy constant}, and is $\epsilon_0 = 8.85 \times 10^{-12} ~ C^2 / N \cdot m^2$.
