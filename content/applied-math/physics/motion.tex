...
A force is \textbf{conservative} if the work done by the force on an object moving it from one point to another depends only on the initial and final positions of the object, and is not dependent on the path taken by the object.
...
\subsection{Energy, Work, Momentum}
