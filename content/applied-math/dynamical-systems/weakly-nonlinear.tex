...
where $0 \leq \epsilon \ll 1$ and $h(x, \dot{x})$ is an arbitrary \dref{smooth} \dref{function} represent small \dref{perturbations} of the \dref{linear} \dref{oscillator} $\dot{x} + x = 0$ and are therefore called \textbf{weakly nonlinear oscillators.}
\end{definition}
