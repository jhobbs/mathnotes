...
\title{Projective Transformations}
...
affine. To get around this, we can use \href{https://en.wikipedia.org/wiki/Homogeneous_coordinates}{homogenous coordinates}, which add another dimension
...
We can just use the value of 1 for the new dimension for all of our points to start with. \href{https://www.tomdalling.com/blog/modern-opengl/explaining-homogenous-coordinates-and-projective-geometry/}{This page} talks a bit more about homogenous coordiantes and why 1 makes a fine value.
...
\href{https://www.brainvoyager.com/bv/doc/UsersGuide/CoordsAndTransforms/SpatialTransformationMatrices.html}{This page} has some examples of more transformations.
